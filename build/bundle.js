...
const Background = ({ config }) => {
  const overlay = config.darken && config.darken > 0 ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      style: {
  ...
  const mediaStyle = config.blur ? { filter: `blur(${config.blur}px)` } : void 0;
  ...
  if (config.type === "image" && config.imageUrl) {
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: config.imageUrl, style: { width: "100%", height: "100%", objectFit: "cover", ...mediaStyle } }) }),
      overlay
    ] });
  }
  if (config.type === "video" && config.videoUrl) {
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Video, { src: config.videoUrl, style: { width: "100%", height: "100%", objectFit: "cover", ...mediaStyle } }) }),
      overlay
    ] });
  }
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: config.color || "#000000" } }),
    overlay
  ] });
};
...
function fitTextToBox(text, config) {
...
;// ./src/components/CaptionBlock.tsx



function getTransitionStyle(currentTime, segment, transition, template) {
  const elapsed = Math.max(currentTime - segment.startTime, 0);
  const remaining = Math.max(segment.endTime - currentTime, 0);
  const duration = Math.max(transition.duration, 1e-3);
  ...
  return {
    opacity,
    transform: `translate(${template.captionBox.x === "center" ? "-50%" : "0"}, ${template.captionBox.y === "center" ? `calc(${translateY}px - 50%)` : `${translateY}px`})`
  };
}
const CaptionBlock = ({
  segment,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        ...
        boxShadow: template.captionBox.shadow ? "0 12px 40px rgba(0,0,0,0.18)" : void 0,
        ...transitionStyle
      },
      children: lines.map((line, lineIndex) => {
        ...
        return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginBottom: 10 }, children: lineWords.map((lineWord, wordIndex) => {
          const absoluteIndex = offset + wordIndex;
          const isActive = absoluteIndex === activeWordIndex;
          const underline = template.highlight.enabled && isActive && template.highlight.underline ? "underline" : void 0;
          return /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "span",
            {
              "data-active": isActive ? "true" : "false",
              style: {
                color: template.highlight.enabled && isActive ? template.highlight.color || template.text.color : template.text.color,
                marginRight: 8,
                textDecoration: underline
              },
              children: lineWord
            },
            `${segment.startTime}-${lineIndex}-${wordIndex}-${lineWord}`
          );
        }) }, `${segment.startTime}-line-${lineIndex}`);
      })
    }
  );
};

;// ./src/components/DesignOverlays.tsx


const DesignOverlays = ({ brand, template }) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    overlays.includes("gradient-scrim") ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
    ...
    overlays.includes("frame-border") ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
    ...
    overlays.includes("cta-bar") ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: brand.ctaText || "Learn More"
      }
    ) : null
  ] });
};
...
function getCornerStyle(position, padding) {
  switch (position) {
    case "top-left":
...
const LogoOverlay = ({ brand, template, audioDuration }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, width } = (0,esm.useVideoConfig)();
  if (!brand.logoUrl || !brand.logoPlacement) {
    return null;
  }
  const opacity = (0,esm.interpolate)(frame, [0, fps], [0, 1], {
  ...
  if (brand.logoPlacement === "intro-card" && frame < fps) {
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      esm.AbsoluteFill,
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: brand.logoUrl, style: { width: logoWidth * 1.6, objectFit: "contain" } }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: brand.textColor || template.text.color, fontFamily: brandFont, fontSize: 42 }, children: brand.tagline || template.name })
        ]
      }
    );
  }
  if (brand.logoPlacement === "outro-card" && frame >= outroStartFrame) {
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      esm.AbsoluteFill,
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: brand.logoUrl, style: { width: logoWidth * 1.8, objectFit: "contain" } }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
  ...
  if (brand.logoPlacement === "lower-third") {
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: brand.logoUrl, style: { width: logoWidth * 0.9, objectFit: "contain" } }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontFamily: brandFont, fontSize: 28 }, children: brand.tagline || template.name })
        ]
      }
    );
  }
  if (brand.logoPlacement === "watermark") {
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: brand.logoUrl, style: { width: logoWidth, objectFit: "contain" } })
      }
    );
  }
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Img, { src: brand.logoUrl, style: { width: logoWidth * 0.8, objectFit: "contain" } })
    }
  );
};
...
function mergeBrandProps(defaults, brand) {
  return {
    ...defaults,
    ...brand,
    designOverlays: (brand == null ? void 0 : brand.designOverlays) ?? defaults.designOverlays ?? []
  };
}
function applyBrandingToTemplate(template, brand) {
...
function stripParagraphMarkers(word) {
  return word.replace(/[\r\n]+/g, "").trim();
}
...
function wrapWords(words, maxCharsPerLine) {
  const lines = [];
  let currentLine = "";
  for (const word of words) {
    const nextLine = currentLine ? `${currentLine} ${word}` : word;
...
function buildSegment(words, nextStartTime) {
  var _a, _b;
  return {
    ...
    startTime: ((_a = words[0]) == null ? void 0 : _a.start) ?? 0,
    endTime: nextStartTime ?? ((_b = words[words.length - 1]) == null ? void 0 : _b.end) ?? 0,
    activeWordIndex: 0
  };
}
function findActiveWordIndex(segment, currentTime) {
  return segment.words.findIndex((word) => currentTime >= word.start && currentTime < word.end);
}
function parseTranscript(wordTimestamps, layout) {
...
;// ./src/compositions/CaptionVSL.tsx
...
const CaptionVSL = ({ template, brand, segments, audioUrl, audioDuration }) => {
  const frame = (0,esm.useCurrentFrame)();
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(Background, { config: resolved.template.background }),
    audioUrl ? /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: audioUrl }) : null,
    activeSegment ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
      CaptionBlock,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(DesignOverlays, { brand: resolved.brand, template: resolved.template }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(LogoOverlay, { brand: resolved.brand, template: resolved.template, audioDuration })
  ] });
};

;// ./src/templates/bold-statement.ts
...
;// ./src/templates/classic-purple.ts
...
;// ./src/templates/modern-minimal.ts
...
;// ./src/templates/notification-card.ts
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "caption-vsl-generator:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcaption_vsl_generator"] = self["webpackChunkcaption_vsl_generator"] || [];
